...
public class BianaceWebSocketClient implements WebSocketStreamClient {
    private static final Logger logger = LoggerFactory.getLogger(com.binance.connector.client.impl.WebSocketStreamClientImpl.class);
