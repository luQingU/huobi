...
public class TWithdrawServiceImpl extends ServiceImpl<TWithdrawMapper, TWithdraw> implements ITWithdrawService {
    ...
    @Override
    public String submit(BigDecimal amount, String coinType, String pwd, String adress, String coin, String bankName, String bankUserName, String bankBranch) {
...
//                }
        ...
        withdraw.setBankUserName(bankUserName);
