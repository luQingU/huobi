...
public class TAppWithdrawController extends ApiBaseController {
    ...
    @PostMapping("submit")
    @Transactional
    public AjaxResult submit(BigDecimal amount, String coinType, String pwd, String adress, String coin,String bankName, String bankUserName, String bankBranch, HttpServletRequest request) {
       String msg = withdrawService.submit(amount,coinType,pwd,adress,coin,bankName,bankUserName,bankBranch);
