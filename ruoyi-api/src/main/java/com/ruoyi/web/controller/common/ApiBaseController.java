...
public class ApiBaseController { protected final Logger logger = LoggerFactory.getLogger(this.getClass());
    ...
    public TAppUser getAppUser(){
        ...
        ITAppUserService appUserService = SpringContextUtil.getBean(ITAppUserService.class);
        return appUserService.selectTAppUserByUserId(loginIdAsLong);
    }
    /**
     * 返回成功
     */
